...
anchor='<section class="case-section" id="language-forensics">'
...
t=must_replace(t,anchor,card+anchor,'political language-forensics section')
p.write_text(t,encoding='utf-8')
