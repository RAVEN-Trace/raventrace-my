...
JS = '<script src="/raventrace-my/assets/js/raven-v5.js?v=5.0.1" defer data-raven-v5-static></script>'
...
for path in paths:
    ...
    if 'data-raven-v5-static' not in text:
        ...
        text = text.replace('/assets/js/raven-v5.js?v=5.0.0', '/assets/js/raven-v5.js?v=5.0.1')
    if text != original:
