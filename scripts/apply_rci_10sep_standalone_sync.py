...
def updates(s):
    ...
    if 'JEJAK / 10-01' not in s and marker in s:
        cards = '''<article class="trace-card"><div class="trace-head"><span>JEJAK / 10-02</span><time datetime="2026-09-10">10 Sep 2026 · Kuala Lumpur</time></div><div class="meta-row"><span class="status fact">DISAHKAN · REMAN TAMAT</span><span class="source-grade">Gred B</span></div><h3>Reman Abdul Azeez dalam siasatan hibah TH tidak disambung.</h3><dl><div><dt>Apa jadi?</dt><dd>Permohonan polis untuk melanjutkan reman tiga hari lagi di bawah Seksyen 420 Kanun Keseksaan ditolak.</dd></div><div><dt>Apa maksudnya?</dt><dd>Siasatan masih boleh diteruskan tanpa reman. Pelepasan daripada reman bukan NFA dan tidak mengubah pertuduhan SPRM yang telah dibaca pada 9 September.</dd></div></dl><p class="inline-sources"><a href="/raventrace-my/investigations/rci-tabung-haji/sources/#s59">S59</a></p></article><article class="trace-card"><div class="trace-head"><span>JEJAK / 10-01</span><time datetime="2026-09-10">10 Sep 2026 · Mahkamah Sesyen Kuala Lumpur</time></div><div class="meta-row"><span class="status fact">DISAHKAN · MAHKAMAH</span><span class="source-grade">Gred B</span></div><h3>Azmi Ahmad didakwa atas dua pertuduhan menipu kadar sewaan harian kapal.</h3><dl><div><dt>Apa jadi?</dt><dd>Azmi mengaku tidak bersalah dan meminta dibicarakan.</dd></div><div><dt>Kenapa penting?</dt><dd>Laporan awal 7 September menjangka 11 September. Rekod mahkamah menunjukkan pertuduhan sebenar dibaca pada 10 September.</dd></div><div><dt>Had</dt><dd>Pertuduhan bukan sabitan.</dd></div></dl><p class="inline-sources"><a href="/raventrace-my/investigations/rci-tabung-haji/sources/#s58">S58</a></p></article>'''
...
def tracks(s):
    ...
    if 'PDRM · hibah 2017 + AMLA' not in s:
        ...
        card = '<article><h3>PDRM · hibah 2017 + AMLA</h3><p>PDRM menahan lima individu dalam dua trek berasingan: tiga bagi siasatan pembayaran hibah 2017 dan dua lagi di bawah Seksyen 4(1) AMLATFPUAA. Pada 10 September, reman Abdul Azeez dalam trek hibah tidak disambung. Dua individu bagi trek AMLA direman hingga 11 September.</p><p>Siasatan, tahanan dan reman bukan pertuduhan atau sabitan.</p><a href="/raventrace-my/investigations/rci-tabung-haji/sources/#s60">S60</a> <a href="/raventrace-my/investigations/rci-tabung-haji/sources/#s59">S59</a></article>'
