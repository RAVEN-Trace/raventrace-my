...
js = '<script src="/raventrace-my/assets/js/raven-narrative-v5.js?v=5.2.0" defer data-raven-narrative-v5></script>'

# Keep the existing visual CSS; V5.2 is a resilience/transformer update.
if css not in text:
...
# Canonicalise any older Narrative V5 JS version to V5.2.
text = re.sub(
...
assert out.count('raven-narrative-v5.js?v=5.2.0') == 1
...
print('Narrative Reading Experience V5.2 resilient wiring PASS')
