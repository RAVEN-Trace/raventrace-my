...
css = '<link rel="stylesheet" href="/raventrace-my/assets/css/raven-narrative-v5.css?v=5.3.2" data-raven-narrative-v5>'
...
assert out.count('raven-narrative-v5.css?v=5.3.2') == 1
